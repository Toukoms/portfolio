    ...
    <section id="skills" className="w-full">
      <div className="w-full anime_hidden">
        ...
        <p className="description">
          ...
          <SuperLink href="https://chingu.io" target="_blank">
            Chingu
          </SuperLink>
          , an online platform that connects developers worldwide. This
          experience has sharpened my ability to work effectively in diverse
